        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item @if(Request::segment(2)=="makaleler") active @endif">
                ...
                <div id="collapseTwo" class="collapse @if(Request::segment(2)=="makaleler") show @endif " aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item @if(Request::segment(2)=="makaleler" and !Request::segment(3) or Request::segment(3)=="silinenler") active @endif" href="{{route('admin.makaleler.index')}}">Tüm Makaleler</a>
                        <a class="collapse-item @if(Request::segment(3)=="olustur")  active @endif" href="{{route('admin.makaleler.create')}}" >Makale Oluştur</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item @if(Request::segment(2)=="sayfalar") active @endif">
                ...
                <div id="collapsePage" class="collapse @if(Request::segment(2)=="sayfalar") show @endif " aria-labelledby="headingPage" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Makale İşlemleri:</h6>
                        <a class="collapse-item @if(Request::segment(2)=="sayfalar" and !Request::segment(3) or Request::segment(3)=="silinenler") active @endif" href="{{route('admin.pages.index')}}">Tüm Sayfalar</a>
                        <a class="collapse-item @if(Request::segment(3)=="olustur")  active @endif" href="{{route('admin.pages.create')}}" >Sayfa Oluştur</a>
                    </div>
                </div>
            </li>
